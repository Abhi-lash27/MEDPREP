      ...
      <div className="menu">
        <div className="formbox">
          ...
          <form  id="register1" className="input-group" autoComplete="off" onSubmit={handelchange}>
            <input type="text" name="doctorname" className="input-field" placeholder="Enter Doctor's Full Name" value= {Name} onChange={(e) =>{setName(e.target.value)}} required />
            {/*<select name="spec" className="input-field" id="spec" onChange={() => myFunction()}>
             ...
             <input type="text" name="Email" className="input-field" id="myinput1" placeholder="Phone" value= {ph} onChange={(e) =>{setPh(e.target.value)}} />
