      ...
      <div className="form">
        ...
        <div className="form-group">
          ...
          <input
            ...
            name="email"
            id="email"
            placeholder="akalyasubramaniane16@gmail.com"
            value={email}
            onChange={(e) => {
        ...
        <div className="form-group">
          <label>
            Aadhaar ID <span>*</span>
          </label>
          <input
            type="text"
            name="aadhaar"
            id="aadhaar"
            placeholder="143524543265"
            value={Ad}
            onChange={(e) => {
        ...
        <div className="form-group">
          <label>
            Person with Disability <span>*</span>
          </label>
          <input
            type="text"
            name="disability"
