        ...
        <div className='assam'>
            ...
            <div className='containe_Book'>
                  ...
                  <div className='input-box'>
                      <label>Phone Number<span> *</span></label>
                       <input type='text' name='phnno' id='phnno'
                        value={ph}
                        onChange={(e) =>setPh(e.target.value) } required/>
                  </div>
                ...
                <div className='input-box'>
                    ...
                    <select name='selectedTime' value={Time} onChange={(e) => setTime(e.target.value)}>
                  ...
                  <select name='doctor' id='doctor' value={doc} onChange={(e) => setDoc(e.target.value)}>
